...
<%
    ...
    String numero = "0"+personne.getNumero();
%>
                ...
                <div class="col-md-9">
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nom" value="<%=personne.getNom()%>" class="form-control" />
                        </div>
                        <div class="form-group">
                            <label for="prenom">Prénom</label>
                            <input type="text" id="prenom" value="<%=personne.getPrenom()%>" class="form-control" />
                        </div>
                        <div class="form-group">
                            <label for="adresse">Adresse</label>
                            <input type="text" id="adresse" value="<%=personne.getAdresse()%>" class="form-control" />
                        </div>
                        <div class="form-group">
                            <label for="numero">Numéro</label>
                            <input type="text" id="numero" value="<%=numero%>" class="form-control" />
                        </div>
                        <div class="form-group">
                            <label for="type">Type (admin | livreur)</label>
                            <input type="text" id="type" value="<%=personne.getType()%>" class="form-control" />
                        </div>
                        <button type="button" id="update" class="btn btn-success">Confirmer</button>
                    </form>
                </div>
            </section>
        </section>
